...
Particle::Particle(GLuint shaderProgram_, GLuint textureID_, std::string filename_) : position(glm::vec3(0.0f)), velocity(glm::vec3(0.0f)), angle(0), lifeTime(3), scale(glm::vec2(1.0f, 1.0f)), colour(glm::vec3(1.0f)), VAO(0), VBO(0), modelLoc(0), projLoc(0), colourLoc(0), textureLoc(0)
{
...
//GLuint Particle::LoadTexture(std::string filename_)
//{
