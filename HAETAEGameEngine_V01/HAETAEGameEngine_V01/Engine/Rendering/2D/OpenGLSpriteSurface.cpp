...
OpenGLSpriteSurface::OpenGLSpriteSurface(std::string imageName_, glm::vec2 scale_, float angle_, glm::vec4 tintColour_, GLuint shaderProgram_) :  VAO(0), VBO(0), modelLoc(0), projLoc(0), colourLoc(0), textureLoc(0)
{
...
GLuint OpenGLSpriteSurface::LoadTexture(std::string filename_)
{
